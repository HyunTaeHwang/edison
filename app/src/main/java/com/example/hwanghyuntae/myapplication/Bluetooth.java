...
public class Bluetooth extends Activity
    ...
    TextView mTextMsg, mGo, mBack, mLeft, mRight;
    EditText mEditData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGo = (TextView)findViewById(R.id.Gobutton);
        mBack = (TextView)findViewById(R.id.Backbutton);
        mLeft = (TextView)findViewById(R.id.Leftbutton);
        mRight = (TextView)findViewById(R.id.Rightbutton);
        // ListView 초기화
        initListView();
    ...
    public void LRbuttonclick(View v)
    {
        switch( v.getId() ) {
            case R.id.LRButton : {
                // 데이터 송수신 스레드가 생성되지 않았다면 함수 탈출
    ...
    public void RRbuttonclick(View v)
    {
        switch( v.getId() ) {
            case R.id.RRbutton : {
                // 데이터 송수신 스레드가 생성되지 않았다면 함수 탈출
