...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            //startActivity(new Intent(LoginActivity.this, citi.class));
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                // startActivity(new Intent(LoginActivity.this, citizen_main.class));
                String type = "login";
                BackgroundWorker backgroundWorker = new BackgroundWorker(LoginActivity.this);
                temp = null;
                try {
                    temp = backgroundWorker.execute(type, mEmail, mPassword).get();
                } catch (InterruptedException e) {
                    e.printStackTrace();
